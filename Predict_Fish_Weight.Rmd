...
Both summaries above state that the best model to use that predicts the weight of perch is the regression model that has the two variables Height-Width. 
